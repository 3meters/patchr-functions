...
describe('Comments', function() {
  ...
  describe('Comment writes', function() {
    ...
    it('comments can created by any channel member', function() {
      const path = "channel-messages/ch-generalxx/me-messagex1/comments/co-commentx2"
  ...
  describe('Comment reactions', function() {
    ...
    it('mary can like and unlike her own comment', function() {
      const path = "channel-messages/ch-privatexx/me-messagex1/comments/co-commentx1/reactions/:thumbsup:/us-janexxxxx"
    ...
    it('jane can like and unlike marys comment', function() {
      const path = "channel-messages/ch-privatexx/me-messagex1/comments/co-commentx1/reactions/:thumbsup:/us-maryxxxxx"
    ...
    it('cheeta cannot like marys comment because he not a channel member', function() {
      const path = "channel-messages/ch-privatexx/me-messagex1/comments/co-commentx1/reactions/:thumbsup:/us-cheetaxxx"
  ...
  describe('Comment reads', function() {
    ...
    it('comments can only be read by channel members or worker', function() {
      const path = "channel-messages/ch-generalxx/me-messagex1/comments"
