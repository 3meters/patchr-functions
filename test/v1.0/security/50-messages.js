...
describe('Messages', function() {
  ...
  describe('Message writes', function() {
    ...
    it('messages can only be created by channel member', function() {
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex3"
    ...
    it('messages can only be updated by message creator', function() {
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex1"
    ...
    it('message photo can be updated by message creator', function() {
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex1/attachments/at-attachxx1"
    ...
    it('messages can only be deleted by message creator', function() {
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex1"
    ...
    it('system message can be created on behalf of channel member', function() {
      let systemMessage = _.clone(message)
      systemMessage.text = "tarzan joined #general"
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex4"
      expect(users.cheeta).cannot.write(null).to.path(path)
      expect(users.jane).can.write(null).to.path(path) // channel member
      expect(users.tarzan).can.write(null).to.path(path) // channel member
    })
  ...
  describe('Message reactions', function() {
    ...
    it('jane can like and unlike her own message in private channel', function() {
      const path = "group-messages/gr-treehouse/ch-privatexx/me-messagex1/reactions/:thumbsup:/us-janexxxxx"
    ...
    it('mary can like and unlike janes message in private channel', function() {
      const path = "group-messages/gr-treehouse/ch-privatexx/me-messagex1/reactions/:thumbsup:/us-maryxxxxx"
    ...
    it('tarzan cannot like janes message because he not a channel member', function() {
      const path = "group-messages/gr-treehouse/ch-privatexx/me-messagex1/reactions/:thumbsup:/us-tarzanxxx"
  ...
  describe('Message reads', function() {
    ...
    it('open channel messages can only be read by group members or worker', function() {
      const path = "group-messages/gr-treehouse/ch-generalxx/me-messagex1"
    ...
    it('private channel messages can only be read by channel members or worker', function() {
      const path = "group-messages/gr-treehouse/ch-privatexx/me-messagex1"
      expect(users.unauth).cannot.read.path(path)
